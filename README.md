...
|----------|------------|------------|
| [CID Investigation Department API](https://github.com/sajjadali-fullstack/cid-investigation-api) |  (CID) system to manage Officers, Criminals, Cases, Evidence & Witnesses — with search, filter, ordering & pagination built-in. 11-13/Jun/26 |<img src="https://skillicons.dev/icons?i=drf,django,sqlite" height="20"/> |
