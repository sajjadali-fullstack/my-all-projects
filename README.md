...
|----------|------------|------------|
| [Groq AI Chat Assistant Django](#) | 🤖 LLM-powered AI Chat Assistant built with Python, Django, and Groq API featuring secure authentication, user-specific persistent chat history, and Django ORM integration.. 14/July/26 |<img src="https://skillicons.dev/icons?i=drf,django,sqlite" height="20"/> |
| [CID Investigation Department API](https://github.com/sajjadali-fullstack/cid-investigation-api) |  (CID) system to manage Officers, Criminals, Cases, Evidence & Witnesses — with search, filter, ordering & pagination built-in. 11-13/July/26 |<img src="https://skillicons.dev/icons?i=drf,django,sqlite" height="20"/> |
