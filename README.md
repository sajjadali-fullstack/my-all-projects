...
|----------|------------|------------|
| [Groq AI Chat Assistant Django](#) | 🤖 LLM-powered AI Chat Assistant built with Python, Django, and Groq API featuring secure authentication, user-specific persistent chat history, and Django ORM integration.. 14/July/26 |<img src="https://skillicons.dev/icons?i=python,django,sqlite" height="20"/> |
| [CID Investigation Department API](https://github.com/sajjadali-fullstack/cid-investigation-api) |  (CID) system to manage Officers, Criminals, Cases, Evidence & Witnesses — with search, filter, ordering & pagination built-in. 11-13/July/26 |<img src="https://skillicons.dev/icons?i=python,drf,django,sqlite" height="20"/> |
...
| [ Django Smart Exam Portal ](https://github.com/sajjadali-fullstack/django-smart-exam-portal) | A responsive online quiz application built with Django and Bootstrap 5, featuring category-based tests, difficulty filters, countdown timers, and performance tracking. |<img src="https://skillicons.dev/icons?i=python,django,bootstrap,mysql" height="20"/> |
...
| [Django Cookie Counter](https://github.com/sajjadali-fullstack/django-cookie-counter) | Showcasing cookie handling, page visit counting, and session management basics. |<img src="https://skillicons.dev/icons?i=python,django,html,css" height="20"/> |
| [🎬 Django Movie App](https://github.com/sajjadali-fullstack/simple-movie-django-project) | A simple Django Movie web application to add, display, and manage movie records using Django forms and models. |<img src="https://skillicons.dev/icons?i=python,django,html" height="20"/> |
| [Django Student Form](https://github.com/sajjadali-fullstack/django-student-form) | Student registration form built using Django with form validation and dynamic data rendering. |<img src="https://skillicons.dev/icons?i=python,django,html" height="20"/> |
| [Python Daily Challenges 2](https://github.com/sajjadali-fullstack/python-daily-challenges-2) | A structured Python daily challenges repository starting from Problem 100, |<img src="https://skillicons.dev/icons?i=python" height="20"/> |
| [Django Employee API (DRF)](https://github.com/sajjadali-fullstack/rest-api-employee-system) | A Django REST Framework based Employee Management API supporting serialization, model |<img src="https://skillicons.dev/icons?i=python,django" height="20"/> |
| [Django Without REST](https://github.com/sajjadali-fullstack/django-without-rest) | A learning project demonstrating Django views, JSON responses, and Class-Based Views as a foundation for Django REST Framework (DRF) |<img src="https://skillicons.dev/icons?i=python,django" height="20"/> |
| [Online Job Portal](https://github.com/sajjadali-fullstack/online-job-search-portal) | Har bade safar ki shuruaat ek chhote kadam se hoti hai. Ye sirf ek project nahi, meri mehnat ki pehli nishani hai." 🥺✨ |<img src="https://skillicons.dev/icons?i=html,bootstrap" height="20"/> |
| [TODOHUB](https://github.com/sajjadali-fullstack/advance-django-todo-hub) | Pending |<img src="https://skillicons.dev/icons?i=python,django" height="20"/> |
| [Temp Portfolio](https://github.com/sajjadali-fullstack/sajjad-ali-portfolio) | A modern, responsive Full-Stack Developer portfolio showcasing projects |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [ Smart Inventory System](https://github.com/sajjadali-fullstack/smart-inventory-system) | A smart, API-driven inventory management engine built with Django & DRF. Features dynamic |<img src="https://skillicons.dev/icons?i=python,django" height="20"/> |
| [GreatKart](https://github.com/sajjadali-fullstack/great-kart) | Pending |<img src="https://skillicons.dev/icons?i=python,django" height="20"/> |
...
| [GenzKart ](https://github.com/sajjadali-fullstack/genz-kart) | A feature-rich Django E-commerce platform with clean architecture and industry-standard backend practices. |<img src="https://skillicons.dev/icons?i=python,django,html,css,bootstrap,mysql" height="20"/> |
| [Django Multi-Step Session Form ](https://github.com/sajjadali-fullstack/django-multi-step-session-form) | A professional multi-step user onboarding application built with Django |<img src="https://skillicons.dev/icons?i=python,django" height="20"/> |
| [Universal Search Hub 🔍](https://github.com/sajjadali-fullstack/universal-search-hub) | A lightweight, pure HTML dashboard to search YouTube, Amazon, Flipkart, and Meesho & etc from one place. |<img src="https://skillicons.dev/icons?i=html" height="20"/> |
| [Frontend Roadmap Project](https://github.com/sajjadali-fullstack/pure-html-project-frontend-roadmap) | An interactive and structured roadmap for aspiring Frontend Developers. Built with HTML |<img src="https://skillicons.dev/icons?i=html" height="20"/> |
...
| [👟 The Shoe Company](https://github.com/sajjadali-fullstack/footwear-ecommerce-ui) | A stylish E-commerce landing page for a premium shoe brand. |<img src="https://skillicons.dev/icons?i=html,tailwind" height="20"/> |
| [QR Restaurant Menu Generator](https://github.com/sajjadali-fullstack/django-qr-restaurant-menu) | Instant QR code generator for digital restaurant menus with download feature | <img src="https://skillicons.dev/icons?i=python,django,boostrap" height="20"/> |
| [Will You Be Mine? Propose Day Special 💌](https://github.com/sajjadali-fullstack/propose-day-special-will-you-be-mine-forever) | Because some questions deserve their own repository 💖 |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Valentine Dashboard 💖](https://github.com/sajjadali-fullstack/valentine-dashboard) | A Valentine’s dashboard with special features that unlock daily leading up to Valentine’s Day. |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Valentine Special Surprise 💖](https://github.com/sajjadali-fullstack/valentine-surprise) | A cute interactive web-based Valentine's proposal with a 'No' button that runs away! , |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Image Gallery](https://github.com/sajjadali-fullstack/image-hover-gallery) | Interactive image gallery with hover effects and cursor-following animations, where images appear |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Cursor Pointer](https://github.com/sajjadali-fullstack/cursor-magic) | A playful custom cursor with smooth motion and hover interactions. |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Digital Clock Pro](https://github.com/sajjadali-fullstack/digital-clock-pro) | Digital clock with toggle and dark/light themes. |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Real Time Clock](https://github.com/sajjadali-fullstack/real-time-digital-clock) | A lightweight digital clock. It shows the current time in 24-hour format and updates every second. |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
| [Insta Heart Like](https://github.com/sajjadali-fullstack/insta-heart-like-project) | Instagram-style post card with interactive likes and double-tap heart effects. |<img src="https://skillicons.dev/icons?i=html,css,js" height="20"/> |
...
| [Task Manager Django TO-DO](https://github.com/sajjadali-fullstack/django-todo-app) | Task management web app with add, update, delete and status tracking | <img src="https://skillicons.dev/icons?i=python,django,bootstrap" height="20"/> |
| [Emoloyee  Dashboard](https://github.com/sajjadali-fullstack/employee-dashboard) | Employee Management System to efficiently add, view, and manage employee records |<img src="https://skillicons.dev/icons?i=python,django,html,css" height="20"/> |
